...
| 検証モデル | gemma 4 (12B / 27B etc.)<br>qwen 3.6 (27B / 35B etc.)<br>ornith 1.0 (9B / 35B etc.) |
...
このような秘匿案件では、クラウド型 AI の利用が承認されないケースは珍しくないです。AI を利用すれば短時間で終わるタスクを長々と時間をかけて手作業する、AI 開発を味わってしまった現在の開発者には苦行です。
...
Google が提供する軽量のオープンウェイトモデル [^gemma-4] です。指示追従性が高く日本語も堪能です。GPT-4.1 や GPT-4o に近い評価 [^gemma-4-31b-vs-gpt-4-1] です。
...
DeepReinforce が開発するコーディング特化のモデル [^ornith_1_0] です。Gemma 4 と Qwen 3.5 を元に開発され、Claude Opus 4.7 と同等の評価があります。
